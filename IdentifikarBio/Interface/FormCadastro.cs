using Biometria.Database;
using Biometria.Database.Objetos;
using Biometria.Dispositivos;
using Biometria.Interface;
using Biometria.Suporte;
...
using static Biometria.Database.CadastroDAO;
using AForge.Video;
using AForge.Video.DirectShow;
using System.Drawing.Imaging;
using System.Threading;
using System.Globalization;
using static Biometria.Suporte.Funcoes;
        ...
        private void bwCarregaDriver_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                if (leitorBiometrico.VerificaConexao())
                {
                    ...
                    cbListaDispositivos.Invoke(new MethodInvoker(() =>
                    {
                        if (leitorBiometrico.listaDispositivos != null && leitorBiometrico.listaDispositivos.Count > 0)
                        {
                            ...
                            btnFuncScanner.Image = global::Biometria.Properties.Resources.FlagDarkGreen;
                ...
                else
                {
                    ...
                    {
                        ((Control)this.tabBiometriaD).Enabled = false;
                        btnFuncScanner.Image = global::Biometria.Properties.Resources.FlagRed;
                    }));
                }
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                if (usbDevices.Count != 0)
                {
                    ...
                    tlpAssinatura.Invoke(new MethodInvoker(() =>
                    {
                        ...
                        btnFuncAssinatura.Image = global::Biometria.Properties.Resources.FlagDarkGreen;
                ...
                else
                {
                    ...
                    {
                        ((Control)this.tabBiometriaAssinatura).Enabled = false;
                        btnFuncAssinatura.Image = global::Biometria.Properties.Resources.FlagRed;
                    }));
                }
            }
            catch (Exception ex)
            ...
            try
            {
                cbCameraemUso.Invoke(new MethodInvoker(() =>
                {
                    ...
                    if (filterInfoCollection != null && filterInfoCollection.Count > 0)
                    {
                        ...
                        btnFuncCamera.Image = global::Biometria.Properties.Resources.FlagDarkGreen;
                        statuscamera = true;
                    ...
                    else
                    {
                        ...
                        {
                            ((Control)this.tabBiometriaF).Enabled = false;
                            btnFuncCamera.Image = global::Biometria.Properties.Resources.FlagRed;
                        }));
                    }
                }));
